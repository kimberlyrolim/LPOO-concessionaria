...
public class CadastroVendaJD extends javax.swing.JDialog {
    ...
    public CadastroVendaJD(java.awt.Frame parent, boolean modal) {
        ...
        // Dispara a ação uma vez no início para carregar o valor do primeiro item (se houver)
    ...
    private void cmbVeiculoActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (veiculoSelecionado != null) {
            txtValor.setText(String.format(java.util.Locale.US, "%.2f", veiculoSelecionado.getValor()));
        }
    }
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        try {
            if (this.venda == null || this.venda.getId() == 0) {
    ...
    public void setVenda(Venda venda) {
        ...
        txtValor.setText(String.format(java.util.Locale.US, "%.2f", venda.getValorVenda()));
